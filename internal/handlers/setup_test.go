...
func getRoutes() http.Handler {
	...
	mux.Post("/admin/reservations-calendar", Repo.AdminPostPostReservationsCalendar)
	mux.Get("/admin/reservations/{src}/{id}/show", Repo.AdminReservationShow)
	mux.Post("/admin/reservations/{src}/{id}", Repo.AdminPostUpdateReservation)
